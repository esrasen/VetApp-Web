...
export const DOCTOR_API = {
    ...
    SEARCH_BY_NAME: (name, pageNumber, pageSize) => `${API_BASE_URL}/doctors/searchByName?name=${name}&pageNumber=${pageNumber}&pageSize=${pageSize}`,
};
export const VACCINATION_API = {
    ...
    SEARCH_BY_NAME: (id, pageNumber, pageSize) => `${API_BASE_URL}/vaccinations/searchByName?name=${id}&pageNumber=${pageNumber}&pageSize=${pageSize}`,
